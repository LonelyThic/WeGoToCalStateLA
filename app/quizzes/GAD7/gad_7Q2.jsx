...
export default function PHQ9Question() {
  ...
  return (
    <View style={styles.container}>
      {/* Title */}
      <Text style={styles.title}>GAD - 7 Question 2</Text>
      ...
      <View style={styles.selectedOption}>
        <Text style={styles.selectedOptionText}>Not being able to stop or control worrying</Text>
      </View>
      ...
      <TouchableOpacity style={styles.continueButton} onPress={() =>
        router.push({ pathname: "/quizzes/GAD7/gad_7Q3",
