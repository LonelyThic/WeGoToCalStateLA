...
export default function PHQ9Question() {
  ...
  return (
    <View style={styles.container}>
      {/* Title */}
      <Text style={styles.title}>GAD - 7 Question 3</Text>
      ...
      <View style={styles.selectedOption}>
        <Text style={styles.selectedOptionText}>Worrying too much about diffrent things</Text>
      </View>
      ...
      <TouchableOpacity style={styles.continueButton} onPress={() =>
        router.push({ pathname: "/quizzes/GAD7/gad_7Q4",
