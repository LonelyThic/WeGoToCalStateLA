...
export default function PHQ9Question() {
  ...
  return (
    <View style={styles.container}>
      {/* Title */}
      <Text style={styles.title}>GAD - 7 Question 5</Text>
      ...
      <View style={styles.selectedOption}>
        <Text style={styles.selectedOptionText}>Being so restless that it is hard to sit still</Text>
      </View>
      ...
      <TouchableOpacity style={styles.continueButton} onPress={() =>
        router.push({ pathname: "/quizzes/GAD7/gad_7Q6",
