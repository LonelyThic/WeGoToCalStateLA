...
export default function PHQ9Question() {
  ...
  return (
    <View style={styles.container}>
      {/* Title */}
      <Text style={styles.title}>GAD - 7 Question 7</Text>
      ...
      <View style={styles.selectedOption}>
        <Text style={styles.selectedOptionText}>Feeling afraid, as if something awful might happen</Text>
      </View>
      ...
      <TouchableOpacity style={styles.continueButton} onPress={() =>
        router.push({ pathname: "/quizzes/GAD7/gad_7ResultsWG",
