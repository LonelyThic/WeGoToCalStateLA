  ...
  return (
    <SafeAreaView style={[styles.container, themeStyles[theme].container]}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        {/* Title */}
        <Text style={[styles.title, themeStyles[theme].title]}>PHQ - 9 Test Disclaimer</Text>
        ...
        {/* Buttons */}
        <TouchableOpacity style={[styles.continueButton, themeStyles[theme].button]} onPress={() => router.push("/quizzes/PHQ9/phq_9Instructions")}>
