...
export default function PHQ9Question() {
  ...
  return (
    <View style={styles.container}>
      {/* Title */}
      <Text style={styles.title}>PHQ - 9 Question 2</Text>
      ...
      <View style={styles.selectedOption}>
        <Text style={styles.selectedOptionText}>Feeling down, depressed, or hopeless</Text>
      </View>
      ...
      <TouchableOpacity style={styles.continueButton} onPress={() =>
        router.push({ pathname: "/quizzes/PHQ9/phq_9Q3",
