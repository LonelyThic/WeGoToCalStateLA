...
export default function PHQ9Question() {
  ...
  return (
    <View style={styles.container}>
      {/* Title */}
      <Text style={styles.title}>PHQ - 9 Question 3</Text>
      ...
      <View style={styles.selectedOption}>
        <Text style={styles.selectedOptionText}>Trouble falling or staying asleep, or sleeping to much</Text>
      </View>
      ...
      {/* Continue Button */}
       <TouchableOpacity style={styles.continueButton} onPress={() =>
              router.push({ pathname: "/quizzes/PHQ9/phq_9Q4",
