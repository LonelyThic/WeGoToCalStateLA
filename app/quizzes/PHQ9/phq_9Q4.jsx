...
export default function PHQ9Question() {
  ...
  return (
    <View style={styles.container}>
      {/* Title */}
      <Text style={styles.title}>PHQ - 9 Question 4</Text>
      ...
      <View style={styles.selectedOption}>
        <Text style={styles.selectedOptionText}>Feeling tired or having little energy</Text>
      </View>
      ...
      {/* Continue Button */}
       <TouchableOpacity style={styles.continueButton} onPress={() =>
              router.push({ pathname: "/quizzes/PHQ9/phq_9Q5",
