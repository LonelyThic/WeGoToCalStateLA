...
export default function PHQ9Question() {
  ...
  return (
    <View style={styles.container}>
      {/* Title */}
      <Text style={styles.title}>PHQ - 9 Question 6</Text>
      ...
      <View style={styles.selectedOption}>
        <Text style={styles.selectedOptionText}>Feeling bad about yourself - 
            or that you are a failure or have let yourself or your familyy down</Text>
      </View>
      ...
      {/* Continue Button */}
       <TouchableOpacity style={styles.continueButton} onPress={() =>
              router.push({ pathname: "/quizzes/PHQ9/phq_9Q7",
