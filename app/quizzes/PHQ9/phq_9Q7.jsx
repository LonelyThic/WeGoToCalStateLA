...
export default function PHQ9Question() {
  ...
  return (
    <View style={styles.container}>
      {/* Title */}
      <Text style={styles.title}>PHQ - 9 Question 7</Text>
      ...
      <View style={styles.selectedOption}>
        <Text style={styles.selectedOptionText}>Trouble concentrating on things, such as reading the newspaper or watching television</Text>
      </View>
      ...
      {/* Continue Button */}
       <TouchableOpacity style={styles.continueButton} onPress={() =>
              router.push({ pathname: "/quizzes/PHQ9/phq_9Q8",
