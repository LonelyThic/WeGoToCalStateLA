...
export default function PHQ9Question() {
  ...
  return (
    <View style={styles.container}>
      {/* Title */}
      <Text style={styles.title}>PHQ - 9 Question 9</Text>
      ...
      <View style={styles.selectedOption}>
        <Text style={styles.selectedOptionText}>Thoughts that you would be better off dead or of huring yourself in some way</Text>
      </View>
      ...
      <TouchableOpacity style={styles.continueButton} onPress={() =>
             router.push({ pathname: "/quizzes/PHQ9/phq_9ResultsWG",
