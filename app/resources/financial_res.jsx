...
const data = [
    {
        id: 1,
        title: "CalFresh",
        description: "Monthly grocery assistance for eligible residents.",
        route: "financial_res",
        icon: "cart",
        resources: [{ label: "getcalfresh.org", url: "https://www.getcalfresh.org" }]
    },
    {
        id: 2,
        title: "BenefitsCal",
        description: "Apply for CalWORKs, Medi-Cal, and more.",
        route: "financial_res",
        icon: "document-text",
        resources: [{ label: "benefitscal.com", url: "https://www.benefitscal.com" }]
    },
    {
        id: 3,
        title: "211 LA",
        description: "Find rent, utility, and financial assistance.",
        route: "financial_res",
        icon: "cash",
        resources: [{ label: "211la.org", url: "https://www.211la.org" }]
    },
    {
        id: 4,
        title: "Cash for College",
        description: "Help with FAFSA and financial aid info.",
        route: "financial_res",
        icon: "school",
        resources: [{ label: "lacashforcollege.org", url: "https://www.lacashforcollege.org" }]
    }
];
    ...
    return (
        <SafeAreaView style={[styles.container, themeStyles[theme].container]}>
            <View style={{ paddingHorizontal: 25 }}>
                <Text style={[styles.header, themeStyles[theme].headerTitle]}>Financial Resources</Text>
            </View>
            <View>
                <Carousel
                    loop
